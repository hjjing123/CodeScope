...
sourceNode:SolonControllerArg OR
  ...
  NOT sourceNode.type  IN ['Long', 'Integer', 'HttpServletResponse','MultipartFile']
...
MATCH
  ...
  ('execute' IN sinkNode.selectors AND 'CloseableHttpClient' IN sinkNode.receiverTypes AND sinkNode.argPosition = 0) OR
  ('execute' IN sinkNode.selectors AND 'CloseableHttpAsyncClient' IN sinkNode.receiverTypes AND sinkNode.argPosition = 0) OR
  ('execute' IN sinkNode.selectors AND 'HttpClient' IN sinkNode.receiverTypes AND sinkNode.argPosition = 0) OR
