"""normalize bootstrap admin defaults for login debug
...
down_revision: str | None = "20260302_0009"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None


pwd_context = CryptContext(schemes=["bcrypt"], deprecated="auto")
LEGACY_BOOTSTRAP_EMAIL = "admin@codescope.local"
DEFAULT_BOOTSTRAP_EMAIL = "admin@example.com"
