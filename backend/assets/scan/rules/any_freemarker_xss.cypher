...
MATCH
  ...
  ('process' IN sinkNode.selectors AND 'Template' IN sinkNode.receiverTypes) OR
  // spring工具类 org.springframework.ui.freemarker.FreeMarkerTemplateUtils
  ('processTemplateIntoString' IN sinkNode.selectors AND 'FreeMarkerTemplateUtils' IN sinkNode.receiverTypes)
MATCH
