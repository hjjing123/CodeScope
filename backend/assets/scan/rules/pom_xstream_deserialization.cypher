...
MATCH
  ...
  WHERE
  sinkNode.groupId = 'com.thoughtworks.xstream' AND   sinkNode.artifactId = 'xstream' AND   sinkNode.realVersion =~ '1\\.4\\.(1|2|3|4|5|6|7|8|9)\\..*' OR
  sinkNode.groupId = 'com.thoughtworks.xstream' AND   sinkNode.artifactId = 'xstream' AND   sinkNode.realVersion  < '1.4.20'
RETURN
  sinkNode AS path
