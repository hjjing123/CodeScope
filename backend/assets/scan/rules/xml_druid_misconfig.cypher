MATCH
  (sinkNode:XmlElement)
  WHERE
  sinkNode.innerText = 'com.alibaba.druid.support.http.StatViewServlet'
RETURN
  sinkNode AS path
/*
Chanzi-Separator
...
com.alibaba.druid.support.http.StatViewServlet 是 Druid 数据库连接池配置的一个Servlet，这个Servlet的启用会带来一些安全风险，主要包括：
