...
import type { ScanResultListParams } from '../../types/finding';

const { Option } = Select;

interface ScanResultFilterBarProps {
  initialFilters?: ScanResultListParams;
  onFilterChange: (filters: ScanResultListParams) => void;
}

const ScanResultFilterBar: React.FC<ScanResultFilterBarProps> = ({
  initialFilters,
  onFilterChange,
}) => {
  ...
  const handleFinish = (values: any) => {
    ...
    const filters: ScanResultListParams = {};
    ...
    <div style={{ padding: '16px 24px', background: '#fff', borderBottom: '1px solid #f0f0f0' }}>
      ...
      >
        ...
        <Form.Item name="status" style={{ minWidth: 120 }}>
          <Select placeholder="Job Status" allowClear>
...
export default ScanResultFilterBar;
