...
if [[ ! -v CODESCOPE_SCAN_EXTERNAL_IMPORT_DATA_MOUNT ]]; then
  export CODESCOPE_SCAN_EXTERNAL_IMPORT_DATA_MOUNT="codescope_neo4j_data"
fi
...
if [[ ! -v CODESCOPE_SCAN_EXTERNAL_NEO4J_RUNTIME_CONTAINER_NAME ]]; then
  export CODESCOPE_SCAN_EXTERNAL_NEO4J_RUNTIME_CONTAINER_NAME="CodeScope_neo4j"
fi
if [[ ! -v CODESCOPE_SCAN_EXTERNAL_NEO4J_RUNTIME_RESTART_MODE ]]; then
  export CODESCOPE_SCAN_EXTERNAL_NEO4J_RUNTIME_RESTART_MODE="docker"
fi
